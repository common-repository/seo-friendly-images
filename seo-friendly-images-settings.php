...
$default_options_data = array (
    ...
    'seo_opt_image_alt_value' => '%name %title',
	'seo_opt_image_title_value' => '',
	'seo_opt_image_override_alt_value' => '1',
	'seo_opt_image_override_title_value' => '1',
   ...
   $seo_opt_image_options_array = wp_parse_args(get_option('seo_opt_image_options_values'), $default_options_data);
  // print_r($seo_opt_image_options_array);
...
if(isset($_POST['submit_general_settings_tab'])){
	...
	$seo_opt_image_options_array['seo_opt_image_alt_value'] = esc_attr($_POST['seo_opt_image_alt_value']);
	$seo_opt_image_options_array['seo_opt_image_title_value'] = esc_attr($_POST['seo_opt_image_title_value']);
	$seo_opt_image_options_array['seo_opt_image_override_alt_value'] = esc_attr($_POST['seo_opt_image_override_alt_value']);
	$seo_opt_image_options_array['seo_opt_image_override_title_value'] = esc_attr($_POST['seo_opt_image_override_title_value']);
	update_option ('seo_opt_image_options_values', $seo_opt_image_options_array );
...
<div class="wrap settings-wrap" id="page-settings">
    ...
    <div id="option-tree-header-wrap">
        <ul id="option-tree-header">
            ...
            <li id="option-tree-version"><span>SEO Friendly Images</span>
            </li>
        </ul>
    </div>
    ...
    <table class="form-table table_custom">
        ...
        <td><input type="text" name="seo_opt_image_alt_value" value="<?php echo esc_attr( $seo_opt_image_options_array['seo_opt_image_alt_value'] ); ?>" />
     ...
     <p class="">    
        ...
        <td><select id="seo_opt_image_override_alt_value" name="seo_opt_image_override_alt_value">
		<?php $override_setting = array(
		'1'=>'YES',
		'0'=>'NO'); ?>
		<?php foreach($override_setting as $key => $value) { ?>
		<option value="<?php echo $key; ?>" <?php if ($seo_opt_image_options_array['seo_opt_image_override_alt_value']==$key) { echo 'selected="selected"'; } ?>  >
        ...
        <td><input type="text" name="seo_opt_image_title_value" value="<?php echo esc_attr( $seo_opt_image_options_array['seo_opt_image_title_value'] ); ?>" />
       ...
       <tr valign="top">
        ...
        <td><select id="seo_opt_image_override_title_value" name="seo_opt_image_override_title_value">
		<?php $override_setting = array(
		'1'=>'YES',
		'0'=>'NO'); ?>
		<?php foreach($override_setting as $key => $value) { ?>
		<option value="<?php echo $key; ?>" <?php if ($seo_opt_image_options_array['seo_opt_image_override_title_value']==$key) { echo 'selected="selected"'; } ?>  >
		<?php _e($value,'seoimages') ?> </option>
		<?php } ?>
		</select>
